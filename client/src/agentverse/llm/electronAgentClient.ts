...
import type { AIMessage, CompletionFn, CompletionResult } from './electronApi';
...
function endpointFor(api: NonNullable<Window['electronAPI']>, id: ProviderId): CompletionFn | undefined {
  switch (id) {
