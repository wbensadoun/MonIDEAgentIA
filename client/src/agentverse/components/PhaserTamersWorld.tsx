...
function mk(text: string, max = 22): string {
...
/* …… React wrapper ………………………………………………………………………………………………………………………………………………… */
export function PhaserTamersWorld({ agents, theme, selectedId, onSelect, onDeselect }: PhaserTamersWorldProps): JSX.Element {
